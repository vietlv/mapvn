...
L.CanvasLayer = L.Layer.extend({
    ...
    function() {
        ...
        ! function() {
            ...
            } else r ? (e.localProducts = ["namConus", "namHawaii", "namAlaska", "iconEu", "arome"], e.globalProducts = ["gfs", "sea", "geos5", "gfsWaves", "iconGlobal"], e.seaProducts = ["sea", "gfsWaves"], e.overlays = ["wind", "gust", "gustAccu", "rain", "rainAccu", "snowAccu", "snowcover", "ptype", "temp", "dewpoint", "rh", "deg0", "clouds", "hclouds", "mclouds", "lclouds", "fog", "cape", "waves", "swell1", "swell2", "wwaves", "currents", "cosc", "dustsm", "so2sm", "pressure"]) : (e.localProducts = [], e.globalProducts = ["gfs", "sea", "gfsWaves"], e.overlays = ["wind", "rain", "temp", "clouds", "waves", "currents", "pressure"]), e.isolines = ["off", "pressure", "gh", "temp"];
